...
extern "C"
{
    ...
    void display_2_8_init(void)
    {
        ...
        g_st7789 =
            new pimoroni::ST7789(320, 240, pimoroni::ROTATE_0, false, pimoroni::get_spi_pins(pimoroni::BG_SPI_FRONT));
        g_graphics = new pimoroni::PicoGraphics_PenRGB332(g_st7789->width, g_st7789->height, nullptr);

        // Initialize RGB LED
        g_led = new pimoroni::RGBLED(pimoroni::PicoDisplay28::LED_R, pimoroni::PicoDisplay28::LED_G,
